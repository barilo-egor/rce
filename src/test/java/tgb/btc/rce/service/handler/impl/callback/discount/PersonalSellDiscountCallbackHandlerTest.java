...
class PersonalSellDiscountCallbackHandlerTest {
    ...
    @InjectMocks
    private PersonalSellDiscountCallbackHandler handler;
    ...
    void handle() {
        ...
        verify(redisUserStateService, times(1)).save(chatId, UserState.NEW_PERSONAL_SELL);
        verify(responseSender, times(1)).sendMessage(chatId,
                "Введите новое значение персональной скидки на продажу: " +
    ...
    void getCallbackQueryData() {
        assertEquals(CallbackQueryData.PERSONAL_SELL_DISCOUNT, handler.getCallbackQueryData());
    }
}