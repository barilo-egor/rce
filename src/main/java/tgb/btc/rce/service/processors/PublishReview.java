...
public class PublishReview extends Processor {
    ...
    public void run(Update update) {
        Long channelChatId = Long.parseLong(BotVariablePropertiesUtil.getVariable(VariableType.CHANNEL_CHAT_ID));
...
//                : "\nОтзыв от @" + review.getUsername();
        ...
        Integer reviewPrise = BotVariablePropertiesUtil.getInt(VariableType.REVIEW_PRISE);
