...
public class HoneyMoneyCallbackQueryHandler implements ICallbackQueryHandler {
    ...
    public void handle(CallbackQuery callbackQuery) {
        botMerchantService.sendRequestMethod(Merchant.HONEY_MONEY, callbackQuery.getMessage().getChatId(), callbackQuery.getData(), callbackQuery.getMessage().getMessageId());
    }

    @Override
    public CallbackQueryData getCallbackQueryData() {
        return CallbackQueryData.HONEY_MONEY_BINDING;
    }
}
