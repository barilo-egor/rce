...
@Service
public class MakeObserverHandler implements ISlashCommandHandler {

    private final IChangeRoleService changeRoleService;

    public MakeObserverHandler(IChangeRoleService changeRoleService) {
        this.changeRoleService = changeRoleService;
    }

    @Override
    public void handle(Message message) {
        changeRoleService.changeRole(message, UserRole.OBSERVER);
    }

    @Override
    public SlashCommand getSlashCommand() {
        return SlashCommand.MAKE_OBSERVER;
    }
}
