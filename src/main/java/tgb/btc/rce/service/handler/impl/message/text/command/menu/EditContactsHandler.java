...
public class EditContactsHandler implements ITextCommandHandler {
    ...
    public EditContactsHandler(IResponseSender responseSender) {
        this.responseSender = responseSender;
    }

    @Override
    public void handle(Message message) {
        responseSender.sendMessage(message.getChatId(), PropertiesMessage.EDIT_CONTACTS_MENU, Menu.EDIT_CONTACTS);
    }
