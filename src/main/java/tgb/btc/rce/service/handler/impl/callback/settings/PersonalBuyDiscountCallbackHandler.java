...
@Service
public class PersonalBuyDiscountCallbackHandler implements ICallbackQueryHandler {
    ...
    public PersonalBuyDiscountCallbackHandler(ICallbackDataService callbackDataService,
    ...
    public void handle(CallbackQuery callbackQuery) {
        ...
        redisUserStateService.save(chatId, UserState.NEW_PERSONAL_BUY);
        responseSender.sendMessage(chatId, "Введите новое значение персональной скидки на покупку: " +
                "<b>положительное</b> для скидки, <b>отрицательное</b> для надбавки.", keyboardService.getReplyCancel());
    }

    @Override
    public CallbackQueryData getCallbackQueryData() {
        return CallbackQueryData.PERSONAL_BUY_DISCOUNT;
    }
}
