...
public class ObserverPanelHandler implements ITextCommandHandler {
    ...
    public ObserverPanelHandler(IResponseSender responseSender) {
        this.responseSender = responseSender;
    }

    @Override
    public void handle(Message message) {
        responseSender.sendMessage(message.getChatId(), "Вы перешли в панель наблюдателя", Menu.OBSERVER_PANEL);
    }
