...
@Service
public class PaymentTypesDiscountsHandler implements ITextCommandHandler {
    ...
    public PaymentTypesDiscountsHandler(IPaymentTypeService paymentTypeService, ICallbackDataService callbackDataService,
