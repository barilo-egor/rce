...
public class OnlyPaysBindingHandler implements ITextCommandHandler {
    ...
    public OnlyPaysBindingHandler(IResponseSender responseSender, IPaymentTypeService paymentTypeService,
    ...
    public void handle(Message message) {
        ...
        List<InlineButton> buttons = new java.util.ArrayList<>(paymentTypes
                ...
                .map(paymentType -> InlineButton.builder()
                        ...
                        .data(callbackDataService.buildData(CallbackQueryData.ONLY_PAYS_BINDING, paymentType.getPid()))
                        .inlineType(InlineType.CALLBACK_DATA)
                        .build())
                .toList()
        );
        responseSender.sendMessage(chatId,
                "Выберите тип оплаты, к которому хотите выполнить привязку метода оплаты OnlyPays. Типы оплаты отображены только для валюты \""
