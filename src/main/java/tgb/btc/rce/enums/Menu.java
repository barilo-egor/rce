...
public enum Menu {
    MAIN(2, ReferralType.STANDARD.isCurrent()
    ...
    DRAWS(2, List.of(Command.LOTTERY, Command.ROULETTE, Command.BACK)),
    ...
    DISCOUNTS(2, ReferralType.STANDARD.isCurrent()
    ...
    USERS(2, ReferralType.STANDARD.isCurrent()
    ...
    BOT_SETTINGS(2, List.of(Command.CURRENT_DATA, Command.ON_BOT, Command.OFF_BOT, Command.BOT_MESSAGES,
            ...
            Command.ADMIN_BACK)),
    REQUESTS(2, ReferralType.STANDARD.isCurrent()
