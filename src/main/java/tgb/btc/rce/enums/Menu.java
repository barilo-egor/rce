...
public enum Menu {
    ...
    PAYMENT_TYPES(2,
            List.of(
                    ...
                    TextCommand.TURN_DYNAMIC_REQUISITES, TextCommand.PAYMENT_TYPE_DISCOUNTS, TextCommand.PAYSCROW_BINDING,
                    TextCommand.DASH_PAY_BINDING, TextCommand.ALFA_TEAM_BINDING, TextCommand.RETURN
            )
    );
