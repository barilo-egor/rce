...
public enum Menu {
    ...
    DISCOUNTS(List.of(Command.RANK_DISCOUNT, Command.PERSONAL_BUY_DISCOUNT, Command.PERSONAL_SELL_DISCOUNT,
            Command.BULK_DISCOUNTS, Command.REFERRAL_PERCENT, Command.ADMIN_BACK)),
    ...
    BOT_SETTINGS(List.of(Command.CURRENT_DATA, Command.ON_BOT, Command.OFF_BOT, Command.BOT_MESSAGES,
                         Command.BOT_VARIABLES, Command.SYSTEM_MESSAGES, Command.PAYMENT_TYPES_OLD, Command.PAYMENT_REQUISITES,
                         Command.ADMIN_BACK)),
    ...
    PAYMENT_TYPES(List.of(Command.NEW_PAYMENT_TYPE, Command.DELETE_PAYMENT_TYPE, Command.NEW_PAYMENT_TYPE_REQUISITE,
                          Command.DELETE_PAYMENT_TYPE_REQUISITE, Command.TURNING_PAYMENT_TYPES));
