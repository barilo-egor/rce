...
public enum BotProperties implements PropertiesReader {
    ...
    BOT_VARIABLE_BUFFER_PROPERTIES(FilePaths.BOT_VARIABLE_BUFFER_PROPERTIES,','),
    BULK_DISCOUNT_PROPERTIES(FilePaths.BULK_DISCOUNT_PROPERTIES, ','),
    BULK_DISCOUNT_BUFFER_PROPERTIES(FilePaths.BULK_DISCOUNT_BUFFER_PROPERTIES,','),
    MESSAGE_PROPERTIES(FilePaths.MESSAGE_PROPERTIES, ','),
    MESSAGE_BUFFER_PROPERTIES(FilePaths.MESSAGE_BUFFER_PROPERTIES,','),
    TURNING_CURRENCIES_PROPERTIES(FilePaths.CURRENCIES_TURNING, ','),
    MODULES_PROPERTIES(FilePaths.MODULES_PROPERTIES, ',');
