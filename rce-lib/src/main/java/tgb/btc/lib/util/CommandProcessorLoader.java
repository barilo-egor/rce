...
import tgb.btc.lib.service.processors.*;
import tgb.btc.lib.service.processors.bulkdiscounts.BulkDiscounts;
import tgb.btc.lib.service.processors.bulkdiscounts.UpdateBulkDiscounts;
import tgb.btc.lib.service.processors.calculator.InlineQueryCalculator;
import tgb.btc.lib.service.processors.calculator.NoneCalculator;
import tgb.btc.lib.service.processors.paymenttypes.PaymentsTypes;
import tgb.btc.lib.service.processors.paymenttypes.create.CreateNewPaymentType;
import tgb.btc.lib.service.processors.paymenttypes.create.FiatCurrencyNewPaymentType;
import tgb.btc.lib.service.processors.paymenttypes.create.NewPaymentType;
import tgb.btc.lib.service.processors.paymenttypes.create.SaveNamePaymentType;
import tgb.btc.lib.service.processors.paymenttypes.delete.DeletePaymentType;
import tgb.btc.lib.service.processors.paymenttypes.delete.DeletingPaymentType;
import tgb.btc.lib.service.processors.paymenttypes.delete.FiatCurrencyDeletePaymentType;
import tgb.btc.lib.service.processors.paymenttypes.delete.ShowPaymentTypesForDelete;
import tgb.btc.lib.service.processors.paymenttypes.minsum.*;
import tgb.btc.lib.service.processors.paymenttypes.requisite.create.AskForNewRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.create.FiatCurrencyCreateRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.create.NewPaymentTypeRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.create.ShowPaymentTypesForCreateRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.delete.DeletingPaymentRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.delete.FiatCurrenciesDeleteRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.delete.ShowPaymentTypesForDeleteRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.delete.ShowRequisitesForDelete;
import tgb.btc.lib.service.processors.paymenttypes.requisite.dynamic.FiatCurrencyDynamicRequisite;
import tgb.btc.lib.service.processors.paymenttypes.requisite.dynamic.TurnDynamicRequisites;
import tgb.btc.lib.service.processors.paymenttypes.requisite.dynamic.TurningDynamic;
import tgb.btc.lib.service.processors.paymenttypes.turning.FiatCurrencyTurnPaymentType;
import tgb.btc.lib.service.processors.paymenttypes.turning.ShowPaymentTypesForTurn;
import tgb.btc.lib.service.processors.paymenttypes.turning.TurnPaymentTypes;
import tgb.btc.lib.service.processors.paymenttypes.turning.TurningPaymentType;
import tgb.btc.lib.service.processors.personaldiscounts.buy.AskPersonalBuyDiscountProcessor;
import tgb.btc.lib.service.processors.personaldiscounts.buy.ChangePersonalBuyDiscountProcessor;
import tgb.btc.lib.service.processors.personaldiscounts.buy.SavePersonalBuyDiscountProcessor;
import tgb.btc.lib.service.processors.personaldiscounts.sell.AskPersonalSellDiscountProcessor;
import tgb.btc.lib.service.processors.personaldiscounts.sell.ChangePersonalSellDiscountProcessor;
import tgb.btc.lib.service.processors.personaldiscounts.sell.SavePersonalSellDiscountProcessor;
import tgb.btc.lib.service.processors.referralpercent.AskNewReferralPercent;
import tgb.btc.lib.service.processors.referralpercent.ReferralPercent;
import tgb.btc.lib.service.processors.referralpercent.SaveReferralPercent;
import tgb.btc.lib.service.processors.spamban.KeepSpamBan;
import tgb.btc.lib.service.processors.spamban.NewSpamBans;
import tgb.btc.lib.service.processors.spamban.ShowSpamBannedUser;
import tgb.btc.lib.service.processors.spamban.SpamUnban;
